...
class GradBoostingRegressor(GeneralRegressor):
    ...
    def create_model(self, X_train, y_train):
        model = GradientBoostingRegressor(learning_rate=self.learning_rate,
    ...
    def optimize_hyperparameters(self, X_train, y_train, y_scaler, learning_rates=[0.05, 0.1, 0.5], subsamples=[0.2, 0.8], max_depths=[4,8]): 
